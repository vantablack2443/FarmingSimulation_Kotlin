...
/**
 * Test for an incident with space between tiles
 */
class IncidentSpaceBetweenTiles : ExampleSystemTestExtension() {
    override val name = "IncidentSpaceBetweenTiles"
    override val description = "Tests that an incident with space between tiles works correctly."

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "incidentSpace/farms.json"
    override val scenario = "incidentSpace/scenario.json"
    override val map = "incidentSpace/map.json"
...
[IMPORTANT] Incident: Incident 0 of type BEE_HAPPY happened and affected tiles 2.
[INFO] Harvest Estimate: Harvest estimate on tile 2 changed to 1260000 g of CHERRY.
...
[IMPORTANT] Simulation Statistics: Total harvest estimate still in fields and plantations: 1260000 g.
    """.trimIndent()
