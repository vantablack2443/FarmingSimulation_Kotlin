...
/**
 * Simple animal attack test
 */
class AnimalAttackTest : ExampleSystemTestExtension() {
    override val name = "AnimalAttackTest"
    override val description = "Tests animal attack."

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "incidents/animalAttackfarms.json"
    override val scenario = "incidents/animalAttackscenario.json"
    override val map = "incidents/animalAttackmap.json"
