...
/**
 * Animal attack one effect multiple animal attack
 */
class AnimalAttackOneEffect : ExampleSystemTestExtension() {
    override val name = "AnimalAttackOneEffect"
    override val description = "Tests more than than one animal attack incidents on a plantable tile."

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "incidents/AnimalAttackOneEffect/farms.json"
    override val scenario = "incidents/AnimalAttackOneEffect/scenario.json"
    override val map = "incidents/AnimalAttackOneEffect/map.json"
