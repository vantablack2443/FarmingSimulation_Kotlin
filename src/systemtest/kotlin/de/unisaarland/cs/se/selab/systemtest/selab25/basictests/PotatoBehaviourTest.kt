...
class PotatoBehaviourTest : ExampleSystemTestExtension() {
    ...
    override suspend fun run() {
        ...
        assertNextLine("[INFO] Harvest Estimate: Harvest estimate on tile 3 changed to 419904 g of POTATO.")
        ...
        assertNextLine("[INFO] Harvest Estimate: Harvest estimate on tile 2 changed to 472392 g of POTATO.")

        // simTick 11, yearTick 16, WEED_MISS(3)
        skipUntilString("[INFO] Simulation Info: Tick 11 started at tick 16 within the year.")
        skipUntilString("[DEBUG] Harvest Estimate: Required actions on tile 3 were not performed: WEEDING.")
        assertNextLine("[INFO] Harvest Estimate: Harvest estimate on tile 3 changed to 377913 g of POTATO.")
        ...
        assertNextLine("[IMPORTANT] Farm Harvest: Machine 1 has collected 531441 g of POTATO harvest.")
        assertNextLine("[IMPORTANT] Farm Machine: Machine 1 is finished and returns to the shed at 10.")
        assertNextLine("[IMPORTANT] Farm Machine: Machine 1 unloads 531441 g of POTATO harvest in the shed.")
        ...
        assertNextLine("[IMPORTANT] Farm Harvest: Machine 2 has collected 472392 g of POTATO harvest.")
        assertNextLine("[IMPORTANT] Farm Machine: Machine 2 is finished and returns to the shed at 20.")
        assertNextLine("[IMPORTANT] Farm Machine: Machine 2 unloads 472392 g of POTATO harvest in the shed.")
        ...
        assertNextLine("[IMPORTANT] Farm Harvest: Machine 3 has collected 377913 g of POTATO harvest.")
        assertNextLine("[IMPORTANT] Farm Machine: Machine 3 is finished and returns to the shed at 30.")
        assertNextLine("[IMPORTANT] Farm Machine: Machine 3 unloads 377913 g of POTATO harvest in the shed.")
