...
class PotatoBehaviourTest : ExampleSystemTestExtension() {
    ...
    override suspend fun run() {
        ...
        assertNextLine("[INFO] Harvest Estimate: Harvest estimate on tile 3 changed to 466560 g of POTATO.")
        ...
        assertNextLine("[INFO] Harvest Estimate: Harvest estimate on tile 2 changed to 583200 g of POTATO.")
        ...
        assertNextLine("[IMPORTANT] Farm Harvest: Machine 1 has collected 729000 g of POTATO harvest.")
        assertNextLine("[IMPORTANT] Farm Machine: Machine 1 is finished and returns to the shed at 10.")
        assertNextLine("[IMPORTANT] Farm Machine: Machine 1 unloads 729000 g of POTATO harvest in the shed.")
        ...
        assertNextLine("[IMPORTANT] Farm Harvest: Machine 2 has collected 583200 g of POTATO harvest.")
        assertNextLine("[IMPORTANT] Farm Machine: Machine 2 is finished and returns to the shed at 20.")
        assertNextLine("[IMPORTANT] Farm Machine: Machine 2 unloads 583200 g of POTATO harvest in the shed.")
        ...
        assertNextLine("[IMPORTANT] Farm Harvest: Machine 3 has collected 419904 g of POTATO harvest.")
        assertNextLine("[IMPORTANT] Farm Machine: Machine 3 is finished and returns to the shed at 30.")
        assertNextLine("[IMPORTANT] Farm Machine: Machine 3 unloads 419904 g of POTATO harvest in the shed.")
