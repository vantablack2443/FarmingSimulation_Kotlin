 ...
 */
class MachineIrrigationTwoMachines : ExampleSystemTestExtension() {
    override val name = "Machine Irrigation Two Machines"
    override val description = "Tests the first tick"
