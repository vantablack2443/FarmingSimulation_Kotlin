 ...
 * Drought Sow Expand
 */
class DroughtSowExpand : ExampleSystemTestExtension() {
    override val name = "Drought Sow Expand"
    override val description = "Drought Sow Expand"

    // Paths are relative from the `src/systemtest/resources` directory.
    override val farms = "droughtSowExpand/farms.json"
    override val scenario = "droughtSowExpand/scenario.json"
    override val map = "droughtSowExpand/map.json"
...
[IMPORTANT] Farm Action: Machine 0 performs SOWING on tile 3 for 4 days.
[IMPORTANT] Farm Sowing: Machine 0 has sowed POTATO according to sowing plan 0.
