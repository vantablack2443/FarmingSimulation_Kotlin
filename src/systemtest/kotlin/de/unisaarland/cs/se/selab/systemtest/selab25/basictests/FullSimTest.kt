...
class FullSimTest : ExampleSystemTestExtension() {
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Farm Action: Machine 5 performs WEEDING on tile 5 for 3 days.")
        assertNextLine("[IMPORTANT] Farm Machine: Machine 5 is finished and returns to the shed at 6.")
    ...
    private suspend fun statistics() {
        ...
        assertNextLine("[IMPORTANT] Simulation Statistics: Total amount of APPLE harvested: 10812 g.")
