...
const val WEEDING_MESSAGE = "[IMPORTANT] Farm Action: Machine 3 performs WEEDING on tile 11 for 3 days."
...
class FullSimTest : ExampleSystemTestExtension() {
    ...
    override suspend fun run() {
        ...
        skipLines(5)
        assertNextLine(WEEDING_MESSAGE)
        skipLines(3)
        ...
        assertNextLine("[IMPORTANT] Incident: Incident 5 of type ANIMAL_ATTACK happened and affected tiles 2.")
        // yeartick 11
        skipLines(5)
