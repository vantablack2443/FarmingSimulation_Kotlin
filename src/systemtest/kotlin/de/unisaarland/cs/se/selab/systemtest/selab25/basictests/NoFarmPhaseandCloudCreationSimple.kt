...
/**
 * No farm phase and cloud creation is valid but simple
 */
class NoFarmPhaseandCloudCreationSimple : ExampleSystemTestExtension() {
    override val name = "NoFarmPhaseandCloudCreationSimple"
    override val description = "No farm phase and cloud creation is valid but simple"
    override val farms = "NoFarmPhaseCloudCreationValidandSimple/farm.json"

    override val scenario = "NoFarmPhaseCloudCreationValidandSimple/scenario.json"
    override val map = "NoFarmPhaseCloudCreationValidandSimple/map.json"
