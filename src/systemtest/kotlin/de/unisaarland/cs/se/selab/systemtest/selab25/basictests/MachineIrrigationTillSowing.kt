 ...
 */
class MachineIrrigationTillSowing : ExampleSystemTestExtension() {
    override val name = "Machine Irrigation Till Sowing nearest tiles"
    override val description = "sowing by nearest tile"
