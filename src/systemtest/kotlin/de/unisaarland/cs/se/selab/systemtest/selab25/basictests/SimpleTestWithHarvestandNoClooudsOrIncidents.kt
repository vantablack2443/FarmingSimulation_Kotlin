...
class SimpleTestWithHarvestandNoCloudsOrIncidents : ExampleSystemTestExtension (){
    ...
    override val description = "Scenario with only sowing in farm phase and no clouds or incidents, short duration, i.e., 4,  for the machine so it should sow all three tiles "
