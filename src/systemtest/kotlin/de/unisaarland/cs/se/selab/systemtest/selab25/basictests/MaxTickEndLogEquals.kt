 ...
 * Tests if log should be Simulation Info: Simulation ended at tick 1.
 */
class MaxTickEndLogEquals : ExampleSystemTestExtension() {
    override val name = "Max Tick End Log Equals"
    override val description = "Tests the simulation end log for max tick 1 - Log Tick = 1"
