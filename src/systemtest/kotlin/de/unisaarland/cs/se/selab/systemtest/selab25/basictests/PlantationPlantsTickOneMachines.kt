 ...
 */
class PlantationPlantsTickOneMachines : ExampleSystemTestExtension() {
    override val name = "PlantationPlantsTickOneMachines"
    override val description = "Tests plantation plants until HE"
