...
class FarmParserTestMissingTilesInField : ExampleSystemTestExtension() {
    ...
    override suspend fun run() {
        ...
        assertNextLine("[IMPORTANT] Initialization Info: Farm2.json is invalid.")
    }
}
