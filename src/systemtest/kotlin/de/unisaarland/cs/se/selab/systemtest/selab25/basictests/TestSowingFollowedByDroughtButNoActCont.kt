 ...
 */
class TestSowingFollowedByDroughtButNoActCont : ExampleSystemTestExtension() {
    override val name = "testSowingFollowedByDroughtNoActCont"
    override val description = "sowing and drought but with no action continuation"
    override val farms = "sowingFolloweedByDroughtNoACtCont/farm.json"
    override val scenario = "sowingFolloweedByDroughtNoACtCont/scenario.json"
    override val map = "sowingFolloweedByDroughtNoACtCont/map.json"
...
[IMPORTANT] Farm: Farm 1 starts its actions.
[DEBUG] Farm: Farm 1 has the following active sowing plans it intends to pursue in this tick: 1.
[IMPORTANT] Farm Action: Machine 1 performs SOWING on tile 4 for 9 days.
