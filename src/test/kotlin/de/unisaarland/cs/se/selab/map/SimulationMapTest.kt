...
class SimulationMapTest {
    ...
    fun setUp() {
        ...
        Tiles.add(Tile(
            1002, Coordinate(-1, 1), TileType.MEADOW, TileShape.SQUARE, airflow = null, direction = null, shed = null, possiblePlants = null, maxMoisture = null ))
        Tiles.add(Tile(
            1003, Coordinate(0, 2), TileType.ROAD, TileShape.OCTAGONAL,  airflow = null, direction = null, shed = null, possiblePlants = null, maxMoisture = null)) // Fixed enum usage
