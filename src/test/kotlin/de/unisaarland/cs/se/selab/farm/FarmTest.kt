 ...
 */
class FarmTest {
    val fields = mutableListOf<Tile>()
    val plantations = mutableListOf<Tile>()
    val farmsteads = mutableListOf<Tile>()
        ...
        machines.addAll(
            mutableListOf(
                Machine(
                    ...
                    listOf(PlantType.APPLE, PlantType.POTATO),
                    farmsteads[0]
                ),
                Machine(
                    2,
                    ...
                    4,
                    farmsteads[0],
                    listOf(ActionType.HARVESTING),
                    listOf(PlantType.ALMOND),
                    farmsteads[0]
                )
            )
        )
    ...
    fun testFarmFunctions() {
        ...
        assertEquals(1, farm.getFields().count { it.actionsNeeded.isNotEmpty() })
        assertEquals(1, farm.getPlantation().count { it.actionsNeeded.isNotEmpty() })
